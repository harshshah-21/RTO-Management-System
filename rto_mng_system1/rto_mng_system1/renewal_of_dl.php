...
<body>
<div class="container">
<h1>Renewal of Driving license</h1>
	<div class="contact-form" style="margin-top:-15px;">
	 <div class="renewal_of_dl">
	 
     <form method="POST" onsubmit="return validateForm()" name="myform" action="renewal_dl_process.php">
	      ...
	      <input type="text" name="username" class="formelement" value="<?php echo $username;?>" required />
		   ...
		   <input type="text" name="dl_no" 	class="formelement" placeholder="Enter Driving License no." required />
		    ...
		    <input type="date" name="date_issue" placeholder="Date of issue" class="formelement" style="width: 100%;" required/>
		    <input type="year" name="date_expiry" placeholder="Year of expiry" class="formelement" style="width: 100%;" required/>
		    <input type="date" name="date_renewal" placeholder="Date of last renewal" class="formelement" style="width: 100%;" required/>
