...
<h1>Driving license</h1>
 ...
 action="driving_process.php">
	      ...
	      <input type="text" name="username" class="formelement" value="<?php echo $username;?>" required />
		   ...
		   <input type="text" name="ll_no" 	class="formelement" placeholder="Enter Learning License no." required />
		   
		   <input type="text" name="vehicle_no" class="formelement"	 placeholder="Enter vehicle no" required />
		   
		    <input type="date" name="date" placeholder="Select date" class="formelement" style="width: 100%;" required/>
