...
<html>
<head>
<title>Registration of motor vehicle</title>
...
<body>
<div class="container">
<h1>Registration of motor vehicle</h1>
	<div class="contact-form" style="margin-top:-15px;">
	 <div class="learning_license">
	 
     <form method="POST" onsubmit="return validateForm()" name="myform" action="reg_motor_vehicle_process.php">
	      ...
	      <input type="text" name="username" class="formelement" value="<?php echo $username;?>" required />
		   ...
		   <input type="text" name="dealers_name" class="formelement"	 placeholder="Enter Dealers name" required  />
	
		  
		<select class="formelement" style="width: 106%;" name="type_of_vehicle" required>
		  ...
		  <input type="date" name="date_of_manuf" placeholder="Select date" class="formelement" style="width: 100%;" required/>
		  
		  <input type="text" name="engine_no" class="formelement" placeholder="Enter Engine no."  required/>
		  
		  <input type="text" name="seat_capacity" class="formelement" placeholder="Enter Seating Capacity" required />
		  
		 <select class="formelement" style="width: 106%;" name="fuel_type" required>
		  
			  <option value="default">Select Fuel Type</option>
			  <option value="0">Petrol</option>
			  <option value="1">Diesel</option>
			  <option value="2">CNG</option>
			  <option value="3">Petrol/Diesel</option>
			  <option value="4">Petrol/CNG</option>
			  <option value="5">Other Fuels</option>
